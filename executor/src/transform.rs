use common::api::{config::Config, definitions::{Definition, DefinitionTemplate}, probes::Probes};
...
pub fn generate_connections_from_probes(mut probes: Vec<Probe>) -> Result<Vec<TargetWithSources>, &'static str> {
    if probes.len() < 2 {
...
pub fn create_api_configs(start_time: Option<u64>, end_time: Option<u64>, billed_to: String, connections: Vec<TargetWithSources>, definition_templates: Vec<DefinitionTemplate>) -> Vec<Config> {
